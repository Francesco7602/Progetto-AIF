...
#des_file = "dat/hidenseek_big.des"
...
env = minihack.MiniHack(des_file=des_content, actions=actions.ACTIONS, max_episode_steps=500, pet=False, observation_keys=['glyphs', 'tty_chars', 'tty_colors', 'chars', 'colors', 'specials', 'glyphs_crop', 'chars_crop', 'colors_crop', 'specials_crop', 'blstats', 'message','inv_strs', 'inv_letters'])
